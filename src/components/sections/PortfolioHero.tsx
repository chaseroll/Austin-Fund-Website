...
export default function PortfolioHero() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-screen min-h-dvh overflow-hidden bg-[#0A0A0A] text-[#EAEAEA]"
    >
      ...
      <div className="relative z-[3] flex min-h-screen min-h-dvh flex-col items-center justify-center">
        <motion.div
          style={{ y: textY }}
